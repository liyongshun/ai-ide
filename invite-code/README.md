...
- 前端：Next.js + TypeScript + Tailwind CSS，集成到主网站中
...
前端已集成到主网站Next.js应用中，位于以下目录：

- `/src/app/invite/verify` - 邀请码验证页面
- `/src/app/invite/admin` - 管理员相关页面
- `/src/lib/api/inviteCodeApi.ts` - API调用服务
